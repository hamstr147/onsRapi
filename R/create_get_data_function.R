...
#'
#' @return A function that takes values of each dimension of the specified data set used to filter the data. These default to NULL, which should return the whole data set.
#'
#' @export
